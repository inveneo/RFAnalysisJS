...
window.GoogleRf = function () {
  ...
  GoogleRf.prototype.createSite = function (lat, lng, radioFrequency, aboveGroundHeight, distance, precision) {
    var mySite;
  ...
  Site = function () {
    ...
    Viewshed = function () {
      ...
      Viewshed.prototype.createRequestUrlBusiness = function (latLngArray, clientId) {
      ...
      Viewshed.prototype.createViewshedBusiness = function () {
